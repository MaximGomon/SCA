...
namespace SCA.CountersService
{
    public class Global : System.Web.HttpApplication
    {
        ...
        protected void Application_BeginRequest(object sender, EventArgs e)
        {
            ...
            {
                //HttpContext.Current.Response.AddHeader("Access-Control-Allow-Headers","Accept, Content-Type,customHeader");
                ...
                //HttpContext.Current.Response.AddHeader("Access-Control-Expose-Headers","customHeader");
